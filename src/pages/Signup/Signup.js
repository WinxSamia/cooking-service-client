                        ...
                        <div className="card-body bg-slate-200 rounded-md ">
                            <form onSubmit={handleSignup}>
                                <div className="form-control">
                                    ...
                                    <input type="text" placeholder="Name" className="input input-bordered bg-slate-200" />
                                </div>
                                <div className="form-control">
                                    <label className="label">
                                ...
                                <div className="form-control mt-6">
                                    <input className="btn bg-teal-600 border-0" type="submit" value="Sign up" />
                                </div>
                            </form>
                            <p className='text-xs'>Have an account? <Link className='text-teal-700 font-bold' to="/login">Login</Link> </p>
                        </div>
                    </div>
                </div>
            </div>
